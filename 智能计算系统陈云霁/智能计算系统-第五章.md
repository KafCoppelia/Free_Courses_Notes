...
#### 执行器逻辑
![Stream_of_Executor](5.3-2-Stream_of_Executor.png)
...
![Schedule_Ready](5.3-3-Schedule_Ready.png)
...
![Inner_Logic_of_Construct](5.4-1-Inner_Logic_of_Construct.png)

3. 训练模型
4. 加载模型执行预测
5. SessionRun由Python到C/C++ API

![Python_to_cpp_API](5.4-2-Python_to_cpp_API.png)

6. C++中的SessionRun流程

![SessionRun_in_cpp](5.4-3-SessionRun_in_cpp.png)
